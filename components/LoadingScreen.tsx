      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-4 md:space-y-6">
            ...
            >
              <FaGithub className="text-5xl md:text-6xl text-green-500"
            ...
            <motion.div
              ...
              className="text-green-500 font-bold text-base md:text-xl tracking-wider text-center"
              style={{ textShadow: '0 0 10px #00ff00' }}
            >
              {text}
            </motion.div>

            <div className="w-full max-w-[200px] md:max-w-[240px] h-2 bg-black rounded-full overflow-hidden">
              <motion.div
